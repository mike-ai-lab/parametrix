# PARAMETRIX P-21 Strong Reload Command

puts "=" * 60
puts "PARAMETRIX P-21 STRONG RELOAD INITIATED"
puts "=" * 60

if defined?(PARAMETRIX)
  puts "[P-21] Clearing existing PARAMETRIX module..."
...
puts "[P-21] PARAMETRIX P-21 loaded successfully!"
puts "=" * 60